...
slider.addEventListener('input', () =>{
    ...
    -slider.value 
    : slider.value;
    alteredColor.style.backgroundColor = alterColor(hexInput.value, valueAddition)
    alteredColoredText.innerText = `Altered Color : ${alterColor(hexInput.value, valueAddition)}`
})
